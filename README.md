...
5. **开发环境**
   - 前端端口：3000
   - 后端代理：[http://localhost:10020](http://localhost:8080)
   - 热重载支持
...
3. **启动应用**
   ...
   ```
4. **访问接口**
   - Swagger 文档：[http://localhost:10020/swagger-ui.html](http://localhost:8080/swagger-ui.html)
   - 健康检查：[http://localhost:10020/api/test/health](http://localhost:8080/api/test/health)
   - 系统信息：[http://localhost:10020/api/test/info](http://localhost:8080/api/test/info)
